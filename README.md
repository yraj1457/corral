...
- **Authorization**, a deny-by-default gate that checks each order against declarative policy before it runs: allowed instruments, order-size and notional limits, position caps, restricted lists. Block on violation, or just log it and watch.
...
# herding: score the fleet against a chance baseline
